...
class UsPhoneTestCase(CommonTestCase):
    ...
    def test_builder_bind(self):
        self.assertEqual(self.control.bind.id, 'us-phone-bind')
        self.assertEqual(self.control.bind.name, 'us-phone')
    ...
    def test_builder_form(self):
        ...
        self.assertEqual(self.control.resource_element.label, 'US Phone Number')
        self.assertEqual(self.control.resource_element.hint, 'US phone number field')
