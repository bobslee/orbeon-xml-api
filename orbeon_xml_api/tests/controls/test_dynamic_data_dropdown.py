...
class DynamicDataDropdownTestCase(CommonTestCase):
    ...
    def test_builder_bind(self):
        self.assertEqual(self.control.bind.id, 'dynamic-data-dropdown-bind')
        self.assertEqual(self.control.bind.name, 'dynamic-data-dropdown')
    ...
    def test_builder_form(self):
        ...
        self.assertEqual(self.control.resource_element.label, 'Dynamic Data Dropdown')
