...
class InputTestCase(CommonTestCase):
    ...
    def test_builder_parent(self):
        ...
        self.assertEqual(self.control.parent.element.label, 'Text Controls')
    ...
    def test_builder_form(self):
        ...
        self.assertEqual(self.control.element.label, 'Input Field')
        self.assertEqual(self.control.element.hint, 'Standard input field')
