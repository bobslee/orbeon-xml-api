...
class NumberTestCase(CommonTestCase):
    ...
    def test_builder_bind(self):
        self.assertEqual(self.control.bind.id, 'number-bind')
        self.assertEqual(self.control.bind.name, 'number')
    ...
    def test_builder_form(self):
        ...
        self.assertEqual(self.control.resource_element.label, 'Number')
        self.assertEqual(self.control.resource_element.hint, 'Number field with validation')
